...
//		driver.findElement(By.xpath("//input[@name='mytext1']")).sendKeys("welcome");                //element is inside the frame.
		...
		driver.switchTo().defaultContent(); // to go back to the page.
...
//		driver.switchTo().defaultContent();
		...
		//using javascript executor , if getting element intercepted exception.
